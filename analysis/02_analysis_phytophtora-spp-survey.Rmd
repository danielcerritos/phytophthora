...
```{r EC50s, message=FALSE, eval=FALSE}
...
```{r LL.4 combine data, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r pooled hormetic model, eval=FALSE, message=FALSE, warning=FALSE}
