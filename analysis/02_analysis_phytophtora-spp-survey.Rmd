...
sojae_corr <- sojae_all_data %>%
  ...
  as.matrix() %>%
  rcorr(type = "pearson")
corrplot(sojae_corr$r, method = "number", type = "upper", order = "hclust", 
         p.mat = sojae_corr$P, sig.level = .05)


col <- colorRampPalette(c("#BB4444", "#EE9988", "#FFFFFF", "#77AADD", "#4477AA"))
corrplot(sojae_corr$r, method = "color", col = col(200),
         type = "upper", order = "hclust", number.cex = 2.5,
         addCoef.col = "black", # Add coefficient of correlation
         tl.col = "black", tl.srt = 90, # Text label color and rotation
         # Combine with significance
         p.mat = sojae_corr$P, sig.level = 0.05, insig = "blank", 
         # hide correlation coefficient on the principal diagonal
         diag = FALSE, tl.cex = 2.5)
