...
samples <- rbind(samples.2016, samples.2017, samples.2018)

write_csv(samples, path = here("output", "clean_data", "01_sample-collection_clean-data.csv"))
```
